...
public class Customer implements Serializable {
	...
	public Customer extUserId(String extUserId) {
	...
	public Customer modifiedBy(String modifiedBy) {
	...
	public String toString() {
		return "Customer{" + "id=" + getId() + ", extUserId='" + getExtUserId() + "'" + ", firstName='" + getFirstName()
				+ "'" + ", middleName='" + getMiddleName() + "'" + ", lastName='" + getLastName() + "'" + ", email='"
				+ getEmail() + "'" + ", phone='" + getPhone() + "'" + ", gender='" + getGender() + "'" + ", active='"
				+ isActive() + "'" + ", verified='" + isVerified() + "'" + ", createdBy='" + getCreatedBy() + "'"
				+ ", createdAt='" + getCreatedAt() + "'" + ", modifiedBy='" + getModifiedBy() + "'" + ", modifiedAt='"
				+ getModifiedAt() + "'" + "}";
	}
}
